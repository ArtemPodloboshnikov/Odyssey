...
import { AuthorizationData, SectionGalaryTypes, SectionJsonTypes } from "@/typings";
...
export default function Admin() {
    ...
    const dataDefault: FormServicesProps = {menu: [], services: [], stocks: {}};
    ...
    useEffect(()=> {
        const getData = async () => {
            ...
            const stocks = await getJSON(SectionJsonTypes.STOCKS);
            setData({
                services: services,
                menu: menu,
                stocks: stocks
                    ...
                    return (
                        <div className="col-start-1 col-end-7 grid grid-cols-6 h-[90vh] max-lg:mt-10 max-lg:overflow-y-auto scrollbar pr-10 h-screen">
                            ...
                            <div className="col-start-5 col-end-7 h-[90vh] overflow-y-auto scrollbar my-20 pr-5 flex flex-col gap-y-10 max-lg:col-start-1 max-lg:ml-10 max-lg:mr-6 max-lg:my-5 max-lg:overflow-visible">
                                ...
                                <FormServices menu={data.menu} services={data.services} stocks={data.stocks} setData={setData} setDialog={setDialog} />
                            </div>
