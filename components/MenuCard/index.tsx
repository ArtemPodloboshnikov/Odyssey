...
const MenuCard: React.FC<MenuCardType> = ({imagePath, title, additional, price}) => {
    return (
        ...
        className="group w-48 h-60 rounded-[12px] bg-center bg-no-repeat bg-cover cursor-pointer"
        >
            <div
            style={{backgroundColor: "rgba(0, 0, 0,.6)"}}
            className="w-full h-full rounded-[12px] flex flex-col place-items-center place-content-center invisible group-hover:visible"
            >
