...
const Input: React.FC<InputProps> = ({placeholder, textHelper, icon, register, type="text"}) => {
    ...
    return (
        ...
        <input className="w-full h-10 pl-3 pr-8 text-base placeholder-gray-600 border rounded-lg outline-none" type={type} placeholder={placeholder} {...register}/>
