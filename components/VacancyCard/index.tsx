...
const VacancyCard: React.FC<VacancyCardType> = ({imagePath, title, description, salary, count, click}) => {
    return (
        ...
        >
            ...
            className="w-full h-full rounded-[12px] flex flex-col place-items-center place-content-center invisible group-hover:visible max-lg:visible max-md:p-5 p-10"
            >
