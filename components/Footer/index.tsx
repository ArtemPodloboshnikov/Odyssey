...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="flex flex-col items-center mt-10 py-5 gap-y-5">
            ...
            <div className="w-full flex flex-row justify-center px-96 max-lg:px-3">
                <Button
                full
                color="#0077FF"
                type="link"
                href={VK_LINK}
                text={
                <svg className="w-12 h-12 fill-white" viewBox="-2.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="grid grid-cols-3 justify-items-center gap-x-20 max-lg:text-xs max-lg:gap-x-5 max-lg:px-5">
                ...
                <div className="flex flex-col text-center">
                    <span>Ежедневно с 19:00 до 07:00</span>
